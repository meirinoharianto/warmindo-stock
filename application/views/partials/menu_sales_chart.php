...
<?php else: ?>
    <div class="alert alert-warning text-center py-4">
        ...
        <p>Tidak ada produk idmenu :<?= $idmenu_sales ?? 'kosong' ?> terjual total <?= $total_qty ?? '' ?> untuk cabang <?= $judul_cabang ?? '' ?> bulan <?= $bln_menu_sales . $bulan[$bln_menu_sales] ?? '' ?> <?= $thn_menu_sales ?></p>
    </div>
<?php endif; ?>