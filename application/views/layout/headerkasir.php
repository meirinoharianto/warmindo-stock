    ...
    <div class="wrapper d-flex align-items-stretch">
        <nav id="sidebar" class="active">
            <ul class="list-unstyled components mb-5">
                ...
                <li>
                    <a href="<?= base_url('kasirstok'); ?>" <?php if (empty($this->input->get('nm'))) {
                ...
                <?php foreach ($kat as $r) { ?>
                    <li>
                        <a href="<?= base_url('kasirstok?id=' . $r->id . '&nm=' . $r->kategori); ?>"
                            <?php if (!empty($this->input->get('nm'))) {
                                if ($this->input->get('nm') == $r->kategori) {
                                    echo "class='active-link'";
                                } else {
                                    echo "";
                                }
