                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" name="date" id="date" placeholder="" value="<?= $edit->date; ?>" readonly="readonly">
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group">
                                    <label for="">Cabang Tujuan</label>
                                    <select class="form-control" name="id_cabang" id="id_cabang" readonly="readonly">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="no_surat" id="no_surat" placeholder="" value="<?= $edit->no_surat; ?>" readonly="readonly">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="">Keterangan</label>
                                    <textarea class="form-control" name="keterangan" id="keterangan" placeholder="" readonly="readonly"><?= $edit->keterangan; ?></textarea>
                                </div>
                            </div>
                        </div>
                        <!-- <div class="row">
                            <div class="col-12">
                                <a href="<?= base_url('bahan/import_transferstok'); ?>" class="btn btn-success btn-block mb-2" readonly="readonly">
