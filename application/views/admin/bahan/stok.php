            ...
            <div class="card-body">
                    ...
                    <div class="dropdown open mb-3">
                        ...
                        <div class="dropdown-menu" style="width:100%" aria-labelledby="triggerId">
                            <?php foreach ($cab as $r) { ?>
                                <a class="dropdown-item" href="<?= base_url('bahan/stok?id=' . $r->id . '&nm=' . $r->nama_toko); ?>">
                                    <?= $r->nama_toko; ?></a>
                                <div class="dropdown-divider"></div>
                            <?php } ?>
                            <a class="dropdown-item" href="<?= base_url('bahan/stok'); ?>">
                                Semua Cabang</a>
                        </div>
                    </div>
                <?php } else { ?>
                ...
                <div class="table-responsive">
                    ...
                    if ($this->input->get('id')) {
                        ...
                        $url   = base_url('bahan/data_stok_bahan?id=' . (int)$this->input->get('id'));
                    } else {
                        $wr = '';
                        $url   = base_url('bahan/data_stok_bahan');
                    }
                    ?>
