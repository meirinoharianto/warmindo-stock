...
<div id="home">
    <div class="container mt-5">
        <a href="<?= base_url('bahan/tambah_stokawal'); ?>" class="btn btn-primary">
            <i class="fa fa-plus"> </i> Tambah Stok Awal Bahan</a>
            ...
            <div class="card-body">
                <div class="dropdown open mb-3">
                    ...
                    <div class="dropdown-menu" style="width:100%" aria-labelledby="triggerId">
                        <?php foreach ($cab as $r) { ?>
                            <a class="dropdown-item" href="<?= base_url('bahan/stokawal?id=' . $r->id . '&nm=' . $r->nama_toko); ?>">
                                <?= $r->nama_toko; ?></a>
                            <div class="dropdown-divider"></div>
                        <?php } ?>
                        <a class="dropdown-item" href="<?= base_url('bahan/stokawal'); ?>">
                            Semua Cabang</a>
                    </div>
                </div>
                ...
                <div class="table-responsive">
                    ...
                    if ($this->input->get('id')) {
                        ...
                        $url   = base_url('bahan/data_stokawal_bahan?id=' . (int)$this->input->get('id'));
                    } else {
                        $wr = '';
                        $url   = base_url('bahan/data_stokawal_bahan');
                    }
                    ?>
...
<script>
    ...
    $(document).ready(function() {
        ...
        tabel = $('#example1').DataTable({
            ...
            "ajax": {
                "url": "<?php echo $url; ?>",
                // "url": "<?= base_url('bahan/data_stokawal_bahan'); ?>", // URL file untuk proses select datanya
                "type": "POST"
            },
            "deferRender": true,
            "aLengthMenu": [
