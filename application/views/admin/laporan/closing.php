        ...
        <div class="row">
                ...
                <div class="col-2">
                    <div class="card card-rounded">
                        ...
                        <div class="card-body">
                            ...
                            <a href="<?= base_url('laporan/closing'); ?>" class="btn btn-info btn-sm mb-1 w-100"> SEMUA CABANG</a>
                            <?php
            ...
            <i class="fa fa-download"></i> File Excel
                    ...
                    <a href="<?php if (in_array($this->session->userdata('ses_level'), array('Admin', 'AdminKasir'))) {
                                    echo base_url('laporan/closing');
                                } else {
                                    echo base_url('laporan/closing?kasir=' . $this->session->userdata('ses_id'));
    ...
    <div class="modal fade" id="modelIdFilter" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form method="GET" action="<?= base_url('laporan/closing'); ?>">
