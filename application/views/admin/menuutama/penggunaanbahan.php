...
<div id="home">
    <div class="container mt-5">
        ...
        <a href="<?= base_url('menuutama/tambah_penggunaanbahan/' . $edit->id); ?>" class="btn btn-primary">
...
<script>
    ...
    $(document).ready(function() {
        ...
        tabel = $('#example1').DataTable({
            ...
            "ajax": {
                "url": "<?= base_url('menuutama/data_penggunaanbahan?id=' . $edit->id); ?>", // URL file untuk proses select datanya
                "type": "POST",
                        ...
                        <?php if ($this->session->userdata('ses_level') == 'Admin') { ?>
                            return `<div class="dropdown open">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="triggerId">
                                            ...
                                            <a href="${base_url}menuutama/edit_penggunaanbahan/${row.id}" 
                                                class="dropdown-item" title="Edit Bahan" role="button">
                                                <i class="fa fa-edit mr-1"></i> Edit Bahan
                                            </a>
                                            <a href="${base_url}menuutama/delete_penggunaanbahan?id=${row.id}" 
