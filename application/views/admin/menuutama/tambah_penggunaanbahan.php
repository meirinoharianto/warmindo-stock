    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-sm-7 mx-auto">
                ...
                ?>
                <form method="POST" action="<?= base_url('menuutama/store_penggunaanbahan'); ?>" enctype="multipart/form-data">
                    <div class="card card-rounded">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="<?= $kode; ?>" name="id_menu"
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="sedang" id="sedang"
                                    placeholder="">
                            </div>
                            <div class="form-group">
                                <label for="">Jumbo</label>
                                <input type="number" class="form-control" name="jumbo" id="jumbo"
                                    placeholder="">
                            </div>
                            <!-- <div class="form-group">
                        ...
                        <div class="card-footer text-muted">
                            <div class="float-right">
                                ...
                                <a href="<?= base_url('menuutama/penggunaanbahan/' . $menu->id); ?>" class="btn btn-danger btn-md">
