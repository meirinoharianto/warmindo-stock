...
<div id="home">
    <div class="container mt-5">
        <a href="<?= base_url('menuutama/tambah'); ?>" class="btn btn-primary">
            <i class="fa fa-plus"> </i> Tambah Menu Utama</a>
        ...
        <!-- <div class="alert alert-warning alert-dismissible fade show" role="alert">
                ...
                <strong>
                    ...
                    <a href="<?= base_url('menu/persediaan?cek=limit'); ?>" class="text-dark mr-2">Cek Disini
                    </a>
                </strong>
            </div> -->
        <?php
...
<script>
    ...
    $(document).ready(function() {
        ...
        tabel = $('#example1').DataTable({
            ...
            "ajax": {
                "url": "<?= base_url('menuutama/data_menu'); ?>", // URL file untuk proses select datanya
                "type": "POST"
            },
            "deferRender": true,
            "aLengthMenu": [
                        ...
                        <?php if ($this->session->userdata('ses_level') == 'Admin') { ?>
                            return `<div class="dropdown open">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="triggerId">
                                            <a href="${base_url}menuutama/detail/${row.id}" 
                                                class="dropdown-item" title="Detail Menu Utama" role="button">
                                                <i class="fa fa-eye mr-1"></i> Detail Menu
                                            </a>
                                            <a href="${base_url}menuutama/penggunaanbahan/${row.id}" 
                                                class="dropdown-item" title="Penggunaan Bahan" role="button">
                                                <i class="fa fa-eye mr-1"></i> Penggunaan Bahan
                                            </a>
                                            <a href="${base_url}menuutama/edit/${row.id}" 
                                                class="dropdown-item" title="Edit Menu Utama" role="button">
                                                <i class="fa fa-edit mr-1"></i> Edit Menu
                                            </a>
                                            <a href="${base_url}menuutama/delete?id=${row.id}" 
                                                onclick="javascript:return confirm('Apakah data ini di hapus ?');" 
                                                class="dropdown-item" title="Hapus Data Menu Utama" role="button">
