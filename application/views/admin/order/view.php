                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td style="text-align: right;width:100px;">Rp<?= number_format($item['harga_jual'] * $item['qty']); ?></td>
                                                <!-- <td>
                                                    <a href="<?= base_url('order/hapus_item?id=' . $item['id'] . '&order_id=' . $t->id); ?>" class="btn btn-danger btn-md" onclick="return confirm('Yakin ingin menghapus data ini ?')">
                                ...
                                <form method="POST" action="<?= base_url('order/updated'); ?>">
                                    <table class="aTable">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <select class="form-control" required name="pesanan" id="pesanan">
                                                        ...
                                                        <option <?php if ($t->pesanan == 'Ditempat') {
                                                                    echo 'selected';
                                                                } ?>>
                                                            Ditempat</option>
                                                        <option <?php if ($t->pesanan == 'Booking') {
                                                                    echo 'selected';
                                                                } ?>>
                                                            Booking</option>
                                                        <option <?php if ($t->pesanan == 'Delivery') {
                                                                    echo 'selected';
                                                                } ?>>
                                                            Delivery</option>
                                                    </select>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" value="<?= number_format($grd); ?>" id="totalBayar1" class="form-control form-lg" readonly>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                        ...
                                        <tr class="diskon">
                                            ...
                                            <td>
                                                <div class="input-group">
                                                    <input type="number" id="Diskon" value="0" min="0" max="100" class="form-control" name="diskon">
                                        ...
                                        <tr class="pajak">
                                            ...
                                            <td>
                                                <div class="input-group">
                                                    <input type="number" id="Pajak" value="0" min="0" max="100" class="form-control" name="pajak">
                                                    <div class="input-group-append">
                                                        <span class="input-group-text" id="basic-addon2">%</span>
                                                    </div>
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" value="0" class="form-control form-lg" name="grandtotal" id="GrandTotal" readonly>
                                                </div>
                                            </td>
                                        </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" id="rupiah1" autocomplete="off" class="form-control" name="dibayar">
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" readonly class="form-control" id="kembaliBayar" name="kembaliBayar">
                                                    </div>
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                ...
                                                <button type="submit" id="prosesTransaksi" class="btn btn-success btn-md btn-block mt-2">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <?php } else { ?>
                    ...
                    <div class="table-responsive">
                        <table id="example1" style="font-size:10.5pt" class="table table-bordered table-striped table" width="100%">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Gambar</th>
...
<!-- // FUNCTION FOR PRINT
function printReceipt(transaction_number) {
var isMobile = /iPhone|iPad|iPod|Android/i.test(navigator.userAgent);
if (isMobile) {
printAndroid('https://warmindo.database.co.id/kasir/apotek/printKasirAndroid/?transaction_number=' + transaction_number);
} else {
printPC('https://warmindo.database.co.id/kasir/apotek/printKasirPC/?transaction_number=' + transaction_number);
}
}
            ...
            $.ajax({
                ...
                success: function(html) {
                    ...
                    <?php if ($pp->print == '1') { ?>
                        if (isMobile) {
                            // alert("1");
                            // alert("<?= base_url('kasir/print2'); ?>");
                            // alert(encodeURI(html));
                            // alert(html);
                            // window.location.href = "intent://" + encodeURI(html) + "#Intent;scheme=quickprinter;package=pe.diegoveloper.printerserverapp;end;";
                            // sendToQuickPrinter();
                            // sendToQuickPrinterChrome("test printer<br><big>Big title<br><cut>");
                            // sendToQuickPrinterChrome("test printer<br><center>Big title<br><cut>");
                            ...
                            // alert("2");
                            // w = window.open("<?= base_url('kasir/print?id=' . $t->no_bon); ?>", "PrintWindow", "width=750,height=650,top=50,left=50,toolbars=no,scrollbars=yes,status=no,resizable=yes");
                            // w.window.print();
                            // w.window.close();
