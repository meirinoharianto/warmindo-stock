                    ...
                    <div class="col-12 mt-3 h-100">
                        <div class="card card-rounded h-100">
                            <div class="card-header bg-primary text-white">
                                <i class="fa fa-cubes mr-1"></i> <?= $title_web; ?>
                            </div>
                                            ...
                                            <div class="input-group input-group-sm align-items-center">
                                                <div class="input-group-append">
                                                    <span class="input-group-text bg-primary text-white">
                                                        <i class="fa fa-calendar mr-1"></i> Data Per Tanggal
                                                    </span>
                                                </div>
                                                <?php if (!empty((int)$this->input->get('jenis'))) { ?>
                                                    <input type="hidden" name="jenis" value="<?= (int)$this->input->get('jenis'); ?>">
                                                <?php } ?>
                                                <input type="date" value="<?= $date; ?>" class="form-control form-control-sm" id="date" required name="tgl"
                                                    aria-describedby="basic-addon2">
                                                <div class="input-group-append">
                                                    <button type="sumbit" id="basic-addon2" class="btn btn-primary btn-sm">
