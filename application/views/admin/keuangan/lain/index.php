                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select name="no_ledger" id="noledger" style="width:100%;" class="form-control select2">
                            <option selected value="" disabled>- pilih ledger - </option>
                            <?php foreach ($ledger as $r) { ?>
                                <option value="<?= $r->no_ledger ?>" data-jen="<?= $r->jenis ?>" data-val="<?= $r->keterangan ?>"><?= $r->no_ledger ?> - <?= $r->keterangan ?></option>
                            <?php } ?>
                        </select>
                    </div>
                    <input type="hidden" placeholder="Misal : Penggajian Karyawan, Beli Alat Kebersihan" class="form-control" name="nama_urusan" id="nama_urusan" placeholder="">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" style="height: 100px" name="keterangan" id="keterangan" placeholder="Masukan Keterangan Jika ada"></textarea>
                    </div>
                </div>
                <div class="modal-footer">
