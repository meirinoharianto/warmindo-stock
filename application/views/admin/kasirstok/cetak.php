...
" data-toggle="modal" data-target="#modelIdWA">
                        ...
                        <div class="col-sm-3">
                            <a href="<?= base_url('kasirstok'); ?>" class="btn btn-secondary btn-block"><i class="fa fa-check mr-1"></i>
                                Selesai</a>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $("#cetak_struk").submit(function(e) {
                e.preventDefault();
                $.ajax({
                    url: "<?= base_url('kasirstok/print?id=' . $t->no_bon); ?>",
                    type: 'POST',
                    ...
                    success: function(html) {
                        <?php if ($pp->print == '1') { ?>
                            if (isMobile) {
                                ...
                                // w = window.open("<?= base_url('kasirstok/print?id=' . $t->no_bon); ?>", "PrintWindow", "width=750,height=650,top=50,left=50,toolbars=no,scrollbars=yes,status=no,resizable=yes");
                                // w.window.print();
                                // w.window.close();
