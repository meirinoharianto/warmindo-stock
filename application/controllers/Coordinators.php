...
class Coordinators extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('admin/coordinators/index', $this->data);
    ...
    public function tambah()
    {
        $this->data = [
            'id_user'     => $this->session->userdata('ses_id'),
            'title_web'  => 'Tambah Koordinator',
            'sidebar'      => 'coordinators',
        ];

        $this->data['title_web'] = 'Tambah User ';
        $this->load->view('layout/header', $this->data);
        $this->load->view('admin/coordinators/tambah', $this->data);
        $this->load->view('layout/footer', $this->data);
    }
    ...
    public function add()
    {
        ...
        if ($this->form_validation->run() != false) {
            ...
            if ($cek->num_rows() > 0) {
                ...
                redirect(base_url('coordinators/tambah'));
            }
            ...
            redirect(base_url('coordinators'));
        } else {
    ...
    public function edit()
    {
        ...
        $this->load->view('layout/header', $this->data);
        $this->load->view('admin/coordinators/edit', $this->data);
        $this->load->view('layout/footer', $this->data);
    }
    ...
    public function upd()
    {
        ...
        $this->db->update_table('login', 'id', $id, $data);
    ...
    public function delete()
    {
        ...
        $cek =  $this->db->query("SELECT * FROM login WHERE login.deleted_at IS NULL AND 
            login.id = ? ", array($id));
        if ($cek->num_rows() > 0) {
            $data = [
            ...
            $this->session->set_flashdata("failed", " Tidak ditemukan data ID dari Koordinator ! ");
            redirect(base_url('coordinators'));
        }
    }
}
